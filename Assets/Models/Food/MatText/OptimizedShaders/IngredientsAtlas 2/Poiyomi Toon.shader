Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/053c068696ae883408bce242f1e370e0"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if ((1.0 /*_OutlineVertexColorMask*/) > 0)
				{
					outlineMask *= lerp(1, v.color[(1.0 /*_OutlineVertexColorMask*/) - 1], (0.0 /*_OutlineVertexColorMaskStrength*/));
				}
				...
				{
					distanceOffset *= lerp(1.0, clamp((distance(_WorldSpaceCameraPos, mul(unity_ObjectToWorld, o.localPos).xyz)), 0.0f, (0.0 /*_OutlinesMaxDistance*/)), (0.5 /*_OutlineFixWidth*/));
				}
				float lineWidth = (0.005 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#ifdef POI_PASS_OUTLINE
				shadowStrength = lerp(0, shadowStrength, (0.36 /*_OutlineShadowStrength*/));
				#endif
				#ifdef _LIGHTINGMODE_FLAT
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				if ((1.0 /*_OutlineVertexColorMask*/) > 0)
				{
					OutlineMask *= lerp(1, poiMesh.vertexColor[(1.0 /*_OutlineVertexColorMask*/) - 1], (0.0 /*_OutlineVertexColorMaskStrength*/));
				}
				...
				{
					float4 hsvg = float4(0,0,0,0.01);
					hsvg.r += (0.72 /*_OutlineHueOffsetSpeed*/) * _Time.x;
				...
				{
					float3 position = (0.0 /*_OutlineAlphaDistanceFadeType*/) ? poiMesh.worldPos : poiMesh.objectPosition;
					poiFragData.alpha *= lerp((0.54 /*_OutlineAlphaDistanceFadeMinAlpha*/), (0.35 /*_OutlineAlphaDistanceFadeMaxAlpha*/), smoothstep((1.36 /*_OutlineAlphaDistanceFadeMin*/), (-57.72 /*_OutlineAlphaDistanceFadeMax*/), distance(position, poiCam.worldPos)));
				}
